<template>
    <div class="container" :class="{ 'animate': props.animate, 'border': props.border }">
        <h3 style="display: flex;justify-content: space-between;align-items: center;padding:0px;"
